...
export class Backend implements backendInterface {
    ...
    async clearChat(arg0: string): Promise<boolean> {
    ...
    async getAllProfiles(): Promise<Array<Message>> {
        if (this.processError) {
            try {
    ...
    async getAllProfilesByEmail(): Promise<Array<Message>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllProfilesByEmail();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
